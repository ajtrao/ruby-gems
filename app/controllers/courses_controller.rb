class CoursesController < ApplicationController
  ...
  def generate_lessons
    #delete future generations to regenerate them
    @course.lessons.where("start > ?", Time.now).destroy_all
    
    #generate next 8 occurences
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:user_id, :classroom_id, :service_id, :start_time, :days, *Course::DAYS_OF_WEEK)
    end
end
